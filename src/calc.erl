...
multi(A,B)->
    gen_server:call(?MODULE, {multi,A,B},infinity).
divi(A,B)->
...
handle_call({add,A,B}, _From, State) ->
     Reply=rpc:call(node(),adder,add,[A,B],2000),
    {reply, Reply, State};
handle_call({multi,A,B}, _From, State) ->
     Reply=rpc:call(node(),multi,multi,[A,B],2000),
    {reply, Reply, State};
handle_call({divi,A,B}, _From, State) ->
     Reply=rpc:call(node(),divi,divi,[A,B],1000),
    {reply, Reply, State};
